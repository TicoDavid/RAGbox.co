export default function DashboardLoading() {
  return (
    <div className="flex flex-1 h-screen bg-[#050505]">
      {/* Left rail skeleton */}
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-gray-500 font-[family-name:var(--font-jakarta)]">
              Loading dashboard...
            </p>
          </div>
        </div>
      ...
      {/* Right rail skeleton */}
      <div className="w-14 border-l border-white/5 flex flex-col items-center py-4 gap-3">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="w-8 h-8 rounded-lg bg-white/5 animate-pulse" />
        ))}
      </div>
