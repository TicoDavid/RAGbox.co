...
export const UnlockIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="none">
    <path d="M12 2a5 5 0 0 0-5 5v3H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-1V7a5 5 0 0 0-5-5zm-2 5v-2a3 3 0 1 1 6 0v2h-6zm2 7a2 2 0 1 1 0 4 2 2 0 0 1 0-4z"/>
  </svg>
);
...
// Insight Action Icons - mapped by action icon name
export const InsightActionIcon: React.FC<{ icon: string }> = ({ icon }) => {
  switch (icon) {
    case 'chart':
      return <CompareIcon />;
    case 'file':
...
// Insight Type Icon - returns the appropriate icon for insight type
export const InsightTypeIcon: React.FC<{ type: string }> = ({ type }) => {
  switch (type) {
    case 'data_trend':
      return <TrendUpIcon />;
