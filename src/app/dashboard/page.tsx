...
/**
 * Dashboard Page - The Sovereign Workspace
 *
 * Design: "Minority Report" for Business
 * Split-Screen Interface:
 * - Left Panel: The Source of Truth (Document Viewer)
 * - Right Panel: The Intelligence (AI Chat)
 *
 * Vibe: Dark, focused, high-contrast data
 */

// Icons (Simple SVGs for the sidebar)
const Icons = {
  Home: () => (
...
export default function Dashboard() {
  ...
  return (
    <motion.div
      className="flex h-screen bg-[#050505] text-white overflow-hidden selection:bg-blue-500/30 font-sans"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.3 }}
    >
      {/* 1. SIDEBAR (The Navigation Rail) */}
      <aside className="w-16 md:w-20 border-r border-white/10 flex flex-col items-center py-6 gap-8 bg-[#0A0A0A]">
        {/* Brand Icon (Small) - White container for logo */}
        ...
        <div className="flex flex-col gap-6 w-full items-center">
          {(['Home', 'Vault', 'Settings'] as const).map((item) => (
            <button
              key={item}
      ...
      <main className="flex-1 flex flex-col relative">
        {/* Header / Breadcrumbs */}
        <header className="h-16 border-b border-white/10 flex items-center justify-between px-6 bg-[#050505]/50 backdrop-blur-md z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-mono text-emerald-500 tracking-wider">SECURE CONNECTION</span>
          </div>
        </header>
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-1/2 border-r border-white/10 bg-[#0A0A0A] relative flex flex-col">
            {/* Toolbar */}
            ...
            <div className="flex-1 p-8 overflow-y-auto flex justify-center bg-[#111]">
              <div className="w-full max-w-xl h-[800px] bg-white text-black p-8 shadow-2xl rounded-sm opacity-90">
                ...
                <h1 className="text-2xl font-bold mb-4 font-serif">Q3 Financial Performance</h1>
                <p className="font-serif text-sm leading-relaxed text-gray-800">
                  This document contains confidential proprietary information. Revenue growth exceeded
                  projections by 14% largely due to the adoption of AI-driven efficiencies in the
                  logistics sector...
                </p>
            ...
            <div className="flex-1 p-6 overflow-y-auto space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-2">
                  <div className="text-sm font-medium text-slate-400">RAGBox Intelligence</div>
                  <div className="text-slate-200 text-sm leading-relaxed max-w-lg">
                    ...
                    . I detected 3 key revenue drivers and a risk factor in the logistics chart. What
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-slate-200 text-sm leading-relaxed max-w-lg">
                    ...
                    <strong className="text-white">14%</strong> specifically attributed to AI
                  ...
                  <div className="mt-2 p-3 rounded-lg bg-emerald-900/10 border border-emerald-500/20 flex items-start gap-3 cursor-pointer hover:bg-emerald-900/20 transition-colors">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-400 line-clamp-1">
                        Page 1 • &quot;...exceeded projections by 14% largely due to...&quot;
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="p-6 pt-2">
              <div className="relative">
                <input
                  ...
                  className="w-full h-14 pl-5 pr-12 rounded-2xl bg-[#111] border border-white/10 text-white placeholder-slate-600 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all shadow-xl"
                />
                <button className="absolute right-2 top-2 h-10 w-10 rounded-xl bg-blue-600 hover:bg-blue-500 text-white flex items-center justify-center transition-colors">
                  <Icons.Send />
                </button>
              </div>
              <div className="text-center mt-3">
                <p className="text-[10px] text-slate-600">
                  RAGBox Sovereign Engine v2.1 • Zero-Retention Mode Active
                </p>
              </div>
            </div>
          </div>
