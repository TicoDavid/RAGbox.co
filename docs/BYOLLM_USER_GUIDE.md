...
| **Does BYOLLM work with Mercury voice?** | Yes. The voice pipeline uses whichever LLM is currently active. If you're on Private LLM, voice queries route through your provider. Latency may vary depending on your provider's response time. |
